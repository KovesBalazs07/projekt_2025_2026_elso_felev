...
$sql = "INSERT INTO kiadas (datum, kategoria, osszeg, megjegyzes, fizetesi_mod)
        VALUES (?, ?, ?, ?, ?)";
...
if ($stmt->execute()) {
  echo json_encode(["success" => true, "message" => "Kiadás sikeresen mentve"], JSON_UNESCAPED_UNICODE);
} else {
