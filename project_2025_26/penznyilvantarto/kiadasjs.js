...
function mentesBevetel() {
    ...
    formData.append("osszeg", document.getElementById("osszeg").value);
    formData.append("megjegyzes", document.getElementById("megjegyzes").value);
    formData.append("fizmod", document.getElementById("fizmod").value);
